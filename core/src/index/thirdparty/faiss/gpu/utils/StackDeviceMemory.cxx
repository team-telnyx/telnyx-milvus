...
size_t
StackDeviceMemory::Stack::getHighWaterHipMalloc() const {
...
void
StackDeviceMemory::setHipMallocWarning(bool b) {
  stack_.hipMallocWarning_ = b;
}
...
StackDeviceMemory::getMemory(hipStream_t stream, size_t size) {
...
size_t
StackDeviceMemory::getHighWaterHipMalloc() const {
  return stack_.getHighWaterHipMalloc();
}
